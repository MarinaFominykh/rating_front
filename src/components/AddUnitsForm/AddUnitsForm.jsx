...
function AddUnitsForm({
  ...
  function handleInputUnit2IdChange(e) {
    e.target.value === "newItem" ? onClick() : setUnit2Id(e.target.value);
  }
  ...
  function handleInputUnit3IdChange(e) {
    e.target.value === "newItem" ? onClick() : setUnit3Id(e.target.value);
  }
  ...
  function handleInputUnit4IdChange(e) {
    e.target.value === "newItem" ? onClick() : setUnit4Id(e.target.value);
  }
  ...
  function handleInputUnit5IdChange(e) {
    e.target.value === "newItem" ? onClick() : setUnit5Id(e.target.value);
  }
  ...
  function handleInputUnit6IdChange(e) {
    e.target.value === "newItem" ? onClick() : setUnit6Id(e.target.value);
  }

  function handleInputUnit6RoleChange(e) {
    e.target.value === "newItem" ? onClick() : setUnit6Role(e.target.value);
  }

  //7
  function handleInputUnit7IdChange(e) {
    e.target.value === "newItem" ? onClick() : setUnit7Id(e.target.value);
  }
  ...
  function handleInputUnit8IdChange(e) {
    e.target.value === "newItem" ? onClick() : setUnit8Id(e.target.value);
  }
  ...
  function handleInputUnit9IdChange(e) {
    e.target.value === "newItem" ? onClick() : setUnit9Id(e.target.value);
  }
  ...
  function handleInputUnit10IdChange(e) {
    e.target.value === "newItem" ? onClick() : setUnit10Id(e.target.value);
  }

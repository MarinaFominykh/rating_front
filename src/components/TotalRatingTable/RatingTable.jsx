...
function RatingTable({ onUpdateUnit, matches, showUnit, handleAddUnit }) {
      ...
      <table className='table'>
        <thead className='table__head'>
          <tr className='table__row table__row-head'>
            ...
            <th
              className='table__cell table__cell-head name__head'
              onClick={() => sortData('name')}
            >
              Ник игрока
            </th>
            <th
              className='table__cell table__cell-head amount__head'
              onClick={() => sortData('matches')}
            >
              Количество игр
            </th>
            <th
              className='table__cell table__cell-head victory__head'
              onClick={() => sortData('victory')}
            >
              Побед
            </th>
            <th
              className='table__cell table__cell-head best__head'
